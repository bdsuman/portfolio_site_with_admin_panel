			...
			<div class="content-wrapper">
				...
				<div class="page-header">
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							<li><a href="#"><i class="icon-image-compare position-left"></i> Service</a></li>
				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							?>
							<form class="form-horizontal" action="../controller/ServiceController.php" method="post" enctype="multipart/form-data">
