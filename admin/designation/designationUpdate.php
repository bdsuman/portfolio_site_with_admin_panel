					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							<?php 
								...
								$getSingleDataQry = "SELECT * FROM designations WHERE id={$designation_id}";
							...
							<form class="form-horizontal" action="../controller/DesignationController.php" method="post" enctype="multipart/form-data">
								<fieldset class="content-group mt-10">
									...
									?>
										...
										<div class="form-group">
											...
											<div class="col-lg-10">
												<input type="text" class="form-control" id="designation_name" name="designation_name" required value="<?php echo $designation['designation_name']; ?>">
											</div>
										</div>
								...
								<div class="text-right">
									...
									<a href="designationList.php" class="btn btn-default">Back To List </a>
								</div>
							</form>
						</div>
