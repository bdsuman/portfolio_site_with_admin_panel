						...
						<div class="panel-body">
							...
							<table class="table table-bordered datatable-basic">
								...
								?>
									<tr>
										<td><?php echo ++$key; ?></td>
										<td><?php echo $contact['contact_topic']; ?></td>
										<td><?php echo $contact['contact_details']; ?></td>
										<td><?php echo $contact['icon_name']; ?></td>
					
										<td class="text-center">
											<a href="contactUpdate.php?contact_id=<?php echo $contact['id']; ?>"><i class="icon-pencil7"></i></a>
											<a href="contactDelete.php?contact_id=<?php echo $contact['id']; ?>"><i class="icon-trash"></i></a>
										</td>
									</tr>
								<?php } ?>
								</tbody>
