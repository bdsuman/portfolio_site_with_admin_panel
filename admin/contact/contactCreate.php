				...
				<div class="content">
					...
					<div class="panel panel-flat">
						...
						<div class="panel-body">
							...
							<form class="form-horizontal" action="../controller/ContactController.php" method="post">
								<fieldset class="content-group mt-10">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" id="contact_topic" name="contact_topic" placeholder="Topic" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<textarea class="form-control" id="contact_details" name="contact_details" placeholder="Details" ></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" placeholder="Icon Name" id="icon_name" name="icon_name" >
										</div>
									</div>
								...
								<div class="text-right">
									<button type="submit" class="btn btn-primary" name="saveContact">Submit</button>
